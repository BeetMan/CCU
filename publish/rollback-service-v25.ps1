# CCUService v25 手动回滚脚本
# 从 ProgramData\CCU_Alternative\deployment-backup-v25.json 恢复部署前路径。
...
$backupFile = Join-Path $env:ProgramData 'CCU_Alternative\deployment-backup-v25.json'
