# CCUService v24 手动回滚脚本
# 从 ProgramData\CCU_Alternative\deployment-backup-v24.json 恢复部署前路径。
...
$backupFile = Join-Path $env:ProgramData 'CCU_Alternative\deployment-backup-v24.json'
